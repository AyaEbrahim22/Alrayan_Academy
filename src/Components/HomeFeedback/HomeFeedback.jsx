                ...
                <div className={style.headingADesign}></div>
                     ...
                     <Slider {...settings} className='h-100'>
                            <div className='d-flex align-items-center justify-content-center flex-column h-100'>
                                <img src={slide2} alt='Woman photo' className={style.photoCircle}/>
                                <h4 className='mb-5 text-light'>Sarah Ahmed</h4>
                                <p className={style.feedbackPara}>I enrolled my son here for Quran and Arabic classes, and I'm thrilled with the progress. The teachers are dedicated, patient, and knowledgeable. His Quranic recitation and Arabic skills have improved significantly. I highly recommend this academy for quality Islamic education</p>
                            </div>
                            ...
                            <div className='d-flex align-items-center justify-content-center flex-column h-100'>
                                <img src={slide2} alt='Woman photo'/>
                            ...
                            <div className='d-flex align-items-center justify-content-center flex-column h-100'>
                                ...
                                <p className={style.feedbackPara}>I've tried various online platforms to learn Quran and Arabic, but none have compared to the experience I've had at this academy. The curriculum is well-structured and the instructors are highly qualified I</p>
                            </div>
