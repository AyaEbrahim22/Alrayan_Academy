    ...
    return <>
        <div className={style.contactComponent}>
            <div className='container'>
                <div className='row text-center gx-4 gy-4 mb-5'>
