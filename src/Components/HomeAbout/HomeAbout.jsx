      ...
      <div className='container'>
        ...
        <div className='row g-4 align-items-center justify-content-center'>
          ...
          <div className='col-md-7'>
            <Zoom>
              <div>
                <img src={aboutImg} alt='About Img' className='w-100 rounded-1' />
              </div>
            </Zoom>
          </div>
